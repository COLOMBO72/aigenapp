  ...
  const features = [
    {
      icon: '💰',
      title: 'Единый баланс',
      desc: 'Пополни баланс один раз и используй для любых сервисов — Pictures и VPN.',
    },
    {
      icon: '🔄',
      title: 'Автопродление',
      desc: 'Настрой автоматическое продление подписки — никогда не потеряешь доступ.',
    },
    {
      icon: '👤',
      title: 'Один аккаунт',
      desc: 'Один аккаунт для всех сервисов Velium. Регистрация один раз.',
    },
    {
      icon: '🇷🇺',
      title: 'Для России',
      desc: 'Все сервисы работают без VPN, серверы в России, оплата через ЮКассу.',
    },
    {
      icon: '⚡',
      title: 'Мгновенный доступ',
      desc: 'Подписка активируется автоматически сразу после оплаты.',
    },
    {
      icon: '🔒',
      title: 'Безопасность',
      desc: 'Данные защищены шифрованием. Мы не продаём информацию о пользователях.',
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Velium — платформа с единым аккаунтом и балансом. ИИ генерация изображений, VPN и многое
          другое.
        </p>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '13px', color: service.color, fontWeight: 500 }}>
                    {service.tag}
                  </p>
                </div>
              </div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            ...
            >
              ...
              >
                {[
                  '5 генераций/день (Flux Schnell)',
                  'Разрешение 512×512',
                  'Галерея изображений',
                ].map((i) => (
                  <div
                    key={i}
                    style={{ display: 'flex', gap: '8px', fontSize: '14px', color: '#a1a1aa' }}
                  >
            ...
            >
              ...
              >
                {[
                  'Безлимит на Flux Schnell',
                  '50 Premium генераций/мес',
                  'Доп. генерации — 5₽/шт',
                  ...
                  <div
                    key={i}
                    style={{ display: 'flex', gap: '8px', fontSize: '14px', color: '#fff' }}
                  >
                    <span style={{ color: '#22c55e' }}>✓</span>
                    {i}
                  </div>
          ...
          >
            ...
            <div>
              <p style={{ fontSize: '16px', fontWeight: 600, marginBottom: '8px' }}>
                Как работает единый баланс
              </p>
              <p style={{ fontSize: '14px', color: '#a1a1aa', lineHeight: 1.7 }}>
                Пополни баланс через ЮКассу и используй средства на любой сервис. Настрой
                автопродление подписки и дополнительные генерации спишутся автоматически с баланса
                по 5₽/шт.
              </p>
            </div>
          </div>
      ...
      <section
        style={{
          padding: '100px 24px',
          textAlign: 'center',
          background: 'linear-gradient(180deg, #0a0a0a 0%, #0d0b1a 100%)',
        }}
      >
        <h2
          style={{
      ...
      {/* Footer */}
      <footer
        style={{ borderTop: '1px solid #2a2a2a', padding: '48px 24px', backgroundColor: '#0d0d0d' }}
      >
        <div
          style={{
            maxWidth: '1200px',
            ...
            <div style={{ display: 'flex', gap: '48px', flexWrap: 'wrap' }}>
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  {[
                    { l: 'Velium Pictures', h: '/services/pictures' },
                    { l: 'Velium VPN', h: '/services/vpn' },
                    { l: 'Тарифы', h: '#pricing' },
                  ].map((x) => (
                    <a
                      key={x.h}
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  {[
                    { l: 'Войти', h: '/dashboard' },
                    { l: 'Регистрация', h: '/dashboard' },
                    { l: 'Баланс', h: '/dashboard' },
                  ].map((x) => (
                    <a
                      key={x.l}
                      href={x.h}
